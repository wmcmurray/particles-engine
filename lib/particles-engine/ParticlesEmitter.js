function ParticlesEmitter(parent, params)
{
	this.params = 
	{
		relative: false,	// 
	...
	this.container = this.params.relative ? jQuery(this.parent)[0] : jQuery(".particles-engine-display")[0];
...
ParticlesEmitter.prototype.reset = function()
{
	this.counter = 0;
...
ParticlesEmitter.prototype.burst = function(amount)
{
...
ParticlesEmitter.prototype.refreshPos = function()
{
	...
	if(this.lastPosRefreshTime)
	{
		...
		pos.substractVector(this.lastPosRefreshPos).multiply(1000 / deltaTime);
		this.vel = pos;
	}
